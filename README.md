# 라즈베리 아카이브 인터페이스 (Raspberry Archive-Interface RAI)

## 소개

라즈베리 아카이브 인터페이스 (RAI)는 라즈베리파이에서 동작하는 가벼운 텍스트 기반 사용자 인터페이스(TUI) 애플리케이션입니다. 개인 아카이브(개인 서버)로 라즈베리파이를 사용할 때 기능적인 도움을 제공합니다.
